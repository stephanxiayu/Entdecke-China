...
class Staedte extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: Text("Timelap Videos" ,style: TextStyle(
                      color: Colors.grey,
                      fontSize: 25,
      ...
      children: <Widget>[
        GestureDetector(
          ...
          child: Container(decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('lib/assets/peking9.png',),
                fit: BoxFit.fill,
              ),
            ),
            child: Text("Peking",  style: TextStyle(
                      color: Colors.grey,
                      fontSize: 25,
          ...
          child: Container(decoration: BoxDecoration(
            ...
            child: Text("Shanghai",  style: TextStyle(
                      color: Colors.grey,
                      fontSize: 25,
                      fontWeight: FontWeight.bold),),)),
          GestureDetector(
        onTap:  () => Navigator.push(
          ...
          child: Container(decoration: BoxDecoration(
            ...
            child: Text("Hongkong",  style: TextStyle(
                      color: Colors.grey,
                      fontSize: 25,
                      fontWeight: FontWeight.bold),),)),
          GestureDetector(
          ...
          child: Container(decoration: BoxDecoration(
            ...
            child: Text("Chongqing",  style: TextStyle(
                      color: Colors.grey,
                      fontSize: 25,
                      fontWeight: FontWeight.bold),),)),
          GestureDetector(
          ...
          child: Container(decoration: BoxDecoration(
            ...
            child: Text("Chinesische Mauer",  style: TextStyle(
                      color: Colors.grey,
                      fontSize: 25,
                      fontWeight: FontWeight.bold),),)),
          GestureDetector(
          ...
          child: Container(decoration: BoxDecoration(
            ...
            child: Text("Shijiazhuang",  style: TextStyle(
                      color: Colors.grey,
                      fontSize: 25,
                      fontWeight: FontWeight.bold),),)),
